...
function ModeratorDashboard() {
  ...
  useEffect(() => { if (resellerConfig?.creditValues && Object.keys(resellerConfig.creditValues).length) setCreditValues((current) => ({ ...current, ...resellerConfig.creditValues })); if (resellerConfig?.visibleProducts && Object.keys(resellerConfig.visibleProducts).length) setResellerVisibleProducts((current) => ({ ...current, ...resellerConfig.visibleProducts })); }, [resellerConfig]);
