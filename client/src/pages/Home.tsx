...
function StoreAdmin() {
  ...
  const [form, setForm] = useState<{ id?: number; name: string; type: "advanced" | "ios" | "ios_ipa" | "panel_ios" | "panel_android" | "proxy_android_clientes"; category: string; description: string; imageUrl: string; demoType: "none" | "image" | "video"; demoUrl: string; price: string; isActive: boolean }>({ name: "", type: "advanced", category: "Proxy", description: "", imageUrl: "", demoType: "none", demoUrl: "", price: "", isActive: true });
  const save = trpc.store.saveProduct.useMutation({ onSuccess: () => { toast.success("Produto salvo."); utils.store.listAdminProducts.invalidate(); setForm({ name: "", type: "advanced", category: "Proxy", description: "", imageUrl: "", demoType: "none", demoUrl: "", price: "", isActive: true }); }, onError: (e) => toast.error(e.message) });
